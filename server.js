    ...
    if(reqPath==='/admin/register'&&method==='POST'){
      ...
      if(d.products&&Array.isArray(d.products)){
        d.products.forEach(up=>{
          ...
          const entry={id:up.productId,name:catProd.name,assignedAt:now,
